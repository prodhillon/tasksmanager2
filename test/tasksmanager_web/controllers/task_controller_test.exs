defmodule TasksmanagerWeb.TaskControllerTest do
  use TasksmanagerWeb.ConnCase

  alias Tasksmanager.Tracker

  @create_attrs %{completed: "some completed", description: "some description", timespent: 42, title: "some title"}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated completed"
    end
